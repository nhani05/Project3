                    ...
                    <div class="col-xs-12 col-sm-12 widget-container-col ui-sortable" bis_skin_checked="1">
                        ...
                        <form class="form-horizontal" role="form" id="form-edit">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-9">
                                    <select class="form-control" name="districtId" id="dicstrictId">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-9">
                                    <input class="form-control" type="text" name="numberOfBasement"
                                           id="numberOfBasement">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-9">
                                    <input class="form-control" type="number" name="rentArea" id="rentArea">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-9">
                                    <input class="form-control" type="number" name="motoFee" id="motoFee">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-9">
                                    <input class="form-control" type="number" name="electricityFee"
                                           id="electricityFee">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-9">
                                    <input class="form-control" type="text" name="decorationTime"
                                           id="decorationTime">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-9">
                                    <input class="form-control" type="text" name="mangagerPhoneNumber"
                                           id="mangagerPhoneNumber">
                                </div>
                            </div>
